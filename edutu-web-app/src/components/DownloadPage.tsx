        ...
        <div className="mx-auto max-w-5xl">
          <section className="space-y-6 border-b pb-10 sm:pb-12">
            ...
            <div className="max-w-3xl space-y-4">
              <h1 className="text-[clamp(2.5rem,6vw,4.5rem)] font-semibold leading-[1] tracking-[-0.05em]">
                Install Edutu once.
                <span className="block text-[#146ef5]">Use it anywhere.</span>
              </h1>

              <p className="max-w-2xl text-[16px] leading-[1.75] text-slate-600 sm:text-[18px]">
