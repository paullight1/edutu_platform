...
import { ArrowLeft, ArrowRight, Check, Eye, EyeOff, Loader2, Lock, Mail, ShieldCheck, User } from 'lucide-react';
...
const AuthScreen: React.FC<AuthScreenProps> = ({ onAuthSuccess }) => {
  ...
  const title = mode === 'sign-in' ? 'Welcome back' : mode === 'verify' ? 'Check your email' : 'Create Account';
  const subtitle =
    mode === 'verify'
            ...
            <div className="relative z-10 flex h-full flex-col justify-between p-8">
              ...
              <div className="rounded-2xl bg-gradient-to-t from-blue-950/30 to-white/5 p-6 backdrop-blur-sm">
                ...
                <div className="mt-7 flex items-end justify-between">
                  ...
                  <div className="flex items-center gap-1 text-lg tracking-[0.18em]">*****</div>
                </div>
            ...
            <div className="w-full max-w-[360px]">
              <div className="mb-8 text-center">
                <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-slate-50 shadow-inner">
                  {mode === 'verify' ? <ShieldCheck className="text-blue-600" size={27} /> : <User className="text-slate-700" size={26} />}
                </div>
              ...
              {mode === 'verify' ? (
                <form onSubmit={handleVerifyEmail} className="space-y-5">
                  ...
                  <button type="button" onClick={handleResendCode} className="w-full text-center text-sm font-medium text-blue-600">
                    Resend code
                  </button>
                </form>
              ) : (
                    ...
                    <FieldShell label="Password">
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`${baseInputClass} px-11`}
