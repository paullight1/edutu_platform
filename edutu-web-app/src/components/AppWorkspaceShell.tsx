          ...
          >
            ...
            <div
              className={cn(
                ...
                isSidebarOpen ? "px-1" : "justify-center px-0",
              )}
            >
              ...
              {isSidebarOpen ? (
                <div className="min-w-0 flex-1">
                  ...
                  <p
                    className={cn("truncate text-xs leading-5 text-text-muted")}
                  >
                    {displayEmail}
                  </p>
                </div>
          ...
          >
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-3">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <NavLink
                  to="/app/profile"
                  className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-brand text-sm font-semibold text-white shadow-sm transition active:scale-[0.98]"
              ...
              {mobilePrimaryWorkspaceNavItems.map((item) => {
                ...
                return (
                  <NavLink
                    ...
                    to={item.to}
                    className={cn(
                      "relative flex h-16 min-w-0 flex-col items-center justify-center gap-1 overflow-hidden px-1 text-2xs font-semibold transition active:scale-[0.98]",
                      active
                        ? "text-brand-600"
