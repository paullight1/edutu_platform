        ...
        <div className="mx-auto max-w-[1200px] space-y-10 lg:space-y-14">
          <section className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            ...
            >
              ...
              <div className="space-y-4">
                <h1
                  className="max-w-3xl text-[clamp(2rem,3.8vw,3.5rem)] font-medium leading-[1.06] tracking-[-0.06em]"
          ...
          >
            <div className="max-w-3xl space-y-3">
              ...
              <h2 className="text-[clamp(1.5rem,2.2vw,2.1rem)] font-medium tracking-[-0.04em]" style={{ color: headingText }}>
          ...
          <section id="data-contract" className="scroll-mt-28 grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            ...
            >
              ...
              <h2 className="text-[clamp(1.5rem,2.2vw,2.15rem)] font-medium tracking-[-0.04em]" style={{ color: headingText }}>
          ...
          >
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-2xl space-y-3">
                ...
                <h2 className="text-[clamp(1.4rem,2vw,2rem)] font-medium tracking-[-0.04em]" style={{ color: headingText }}>
